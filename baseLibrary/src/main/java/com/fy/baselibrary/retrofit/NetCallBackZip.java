 ...
 */
public abstract class NetCallBackZip<V, V1> implements Observer<V1> {

    private Disposable disposed;
    private IProgressDialog progressDialog;
    private CommonDialog dialog;

    public NetCallBackZip() {
    }

    public NetCallBackZip(IProgressDialog pDialog) {
     ...
     * @param t 请求返回的数据
     */
    protected abstract void onSuccess(V1 t);
    ...
    protected Observable<V1> zipRequest(V v){
        return null;
    }
